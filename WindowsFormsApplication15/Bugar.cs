...
public class Bugar:Prasinar
{
    ...
    public override void Crtaj(Graphics g){
        ...
        g.FillPolygon(b, new Point[]{new Point{X=x+11*a/4,Y=y-5*a-a/4},new Point{X=x+13*a/4,Y=y-4*a-3*a/4},
                                     new Point{X=x+4*a,Y=y-6*a}});
        g.DrawPolygon(p, new Point[]{new Point{X=x+11*a/4,Y=y-5*a-a/4},new Point{X=x+13*a/4,Y=y-4*a-3*a/4},
                                     new Point{X=x+4*a,Y=y-6*a}});
    }
